...
class ManageTempalteWatchDir {
    constructor(config) {
        ...
        const templateConfig = Object.assign(Object.assign({}, defaultConfig.installDefault), config === null || config === void 0 ? void 0 : config.installDefault);
        templateConfig.page && this.createTemplate.addPlugin(new vuePagePlugin_1.VuePagePlugin());
        templateConfig.directive && this.createTemplate.addPlugin(new vueDirectivePlugin_1.VueDirectivePlugin());
        templateConfig.component && this.createTemplate.addPlugin(new vueComponentPlugin_1.VueComponentPlugin());
        templateConfig.componentModule && this.createTemplate.addPlugin(new vueComponentModulePlugin_1.VueComponentModulePlugin());
    }
    addPlugin(tpPlugin) {
